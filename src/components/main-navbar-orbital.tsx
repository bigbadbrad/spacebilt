// /components/main-navbar-orbital.tsx
'use client';
...
import { LogoOrbital } from './logo-orbital';
...
export const MainNavbarOrbital: FC<MainNavbarProps> = ({ colorScheme = 'dark' }) => {
        ...
        >
          ...
          >
            <Link href="/" passHref>
              ...
              >
                <LogoOrbital height={isMobile ? 45 : 82} fill={logoFillColor} />
              </Box>
            </Link>
          </Box>
        </Toolbar>
